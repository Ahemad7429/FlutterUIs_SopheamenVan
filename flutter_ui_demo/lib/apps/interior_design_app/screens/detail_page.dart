          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image:
                      AssetImage("assets/images/interior_app/image_detail.png"),
                  fit: BoxFit.cover),
            ),
            child: SafeArea(
              child: Padding(
                  ...
                  children: <Widget>[
                    InkWell(
                        ...
                        child: SvgPicture.asset(
                            "assets/images/interior_app/back_icon.svg")),
                    Row(
                      children: <Widget>[
                        SvgPicture.asset(
                            "assets/images/interior_app/heart_icon.svg"),
                        SizedBox(
                          width: 20,
                        ),
                        SvgPicture.asset(
                            "assets/images/interior_app/share_icon.svg"),
                      ],
                    )
                  ],
                ),
