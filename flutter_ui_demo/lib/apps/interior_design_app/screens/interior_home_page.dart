...
import 'package:flutter_ui_demo/apps/interior_design_app/screens/detail_page.dart';

class InteriorHomePage extends StatefulWidget {
  @override
  _InteriorHomePageState createState() => _InteriorHomePageState();
}

class _InteriorHomePageState extends State<InteriorHomePage> {
  @override
        ...
        child: Column(
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                SvgPicture.asset("assets/images/interior_app/burger_icon.svg"),
                Row(
                  children: <Widget>[
                    SvgPicture.asset(
                        "assets/images/interior_app/search_icon.svg"),
                    SizedBox(
                      width: 20,
                    ),
                    Container(
            ...
            Row(
              ...
              children: <Widget>[
                ...
                SvgPicture.asset("assets/images/interior_app/forward_icon.svg")
              ],
            ),
            SizedBox(
              height: 30,
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(
                            "assets/images/interior_app/image_1.png"))),
              ),
            ),
            SizedBox(
              height: 20,
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage(
                                  "assets/images/interior_app/image_2.png"),
                              fit: BoxFit.cover)),
                    ),
                    SizedBox(
                      height: 20,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage(
                                  "assets/images/interior_app/image_3.png"),
                              fit: BoxFit.cover)),
                    ),
                  ],
                ),
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage(
                                  "assets/images/interior_app/image_4.png"),
                              fit: BoxFit.cover)),
                    ),
                    SizedBox(
                      height: 20,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage(
                                  "assets/images/interior_app/image_5.png"),
                              fit: BoxFit.cover)),
                    ),
                  ],
                )
